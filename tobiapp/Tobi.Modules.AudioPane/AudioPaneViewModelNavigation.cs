        ...
        private void initializeCommands_Navigation()
        {
            ...
            CommandFastForward = new RichDelegateCommand(
                ...
                () =>
                {
                    ...
                    long newBytesPosition = PlayBytePosition + State.Audio.GetCurrentPcmFormat().Data.ConvertTimeToBytes((long)Settings.Default.AudioWaveForm_PlayPreviewTimeStep * AudioLibPCMFormat.TIME_UNIT);
            ...
            CommandRewind = new RichDelegateCommand(
                ...
                () =>
                {
                    ...
                    long newTimeBytePosition = PlayBytePosition - State.Audio.GetCurrentPcmFormat().Data.ConvertTimeToBytes((long)Settings.Default.AudioWaveForm_PlayPreviewTimeStep * AudioLibPCMFormat.TIME_UNIT);
