...
namespace Tobi.Plugin.DocumentPane {
    ...
    public class Tobi_Plugin_DocumentPane_Lang {
        ...
        public static string ConfirmDisplayValidationDialog {
            get {
                return ResourceManager.GetString("ConfirmDisplayValidationDialog", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to (this message will be displayed only once per project session).
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Please be aware that editing the structure of the document is an expert feature, and note that only the DAISY DTBOOK markup is checked for XML errors (not EPUB3 XHTML5). When exporting your project, make sure that the document is valid..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Invalid structure edit.
        /// </summary>
        public static string StructureEditValidationErrorAskDisplayDialog {
            get {
                return ResourceManager.GetString("StructureEditValidationErrorAskDisplayDialog", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to XML error, try again?.
        /// </summary>
        public static string XmlErrorTryAgain {
            get {
                return ResourceManager.GetString("XmlErrorTryAgain", resourceCulture);
            }
        }
    }
}
