...
namespace Tobi.Plugin.Validator.ContentDocument
{
    ...
    public sealed class ContentDocumentValidatorPlugin : AbstractTobiPlugin
    {
        ...
        {
            get { return Tobi_Plugin_Validator_ContentDocument_Lang.ContentDocumentValidator_Name; }    // TODO LOCALIZE ContentDocumentValidatorPlugin_Name
        }

        public override string Description
        {
            get { return Tobi_Plugin_Validator_ContentDocument_Lang.ContentDocumentValidator_Description; }   // TODO LOCALIZE ContentDocumentValidatorPlugin_Description
        }
    }
}
